...
![screenshot](./img/Ziggurat_0.png)
![screenshot](./img/Ziggurat_1.png)
![screenshot](./img/Ziggurat_2.png)
...
[BOX64] Error: Reading elf header of /home/sipeed/games/GOG Games/Ziggurat/start.sh, Try to launch using bash instead
[BOX64] Dynarec for rv64g_xtheadba_xtheadbb_xtheadbs_xtheadmempair_xtheadcondmov_xtheadmemidx_xthvector
[BOX64] Running on unknown riscv64 cpu with 4 cores, pagesize: 4096
[BOX64] Will use hardware counter measured at 3.0 MHz emulating 3.0 GHz
[BOX64] Using bash "/home/sipeed/ourstorybegin/box64/box64_/tests/box64-bash"
...
[BOX64] BOX64 LIB PATH: 
[BOX64] BOX64 BIN PATH: ./:bin/:/home/sipeed/ourstorybegin/wine/wine-9.22-amd64-wow64/bin/:/usr/local/bin/:/usr/bin/:/bin/:/usr/local/games/:/usr/games/
[BOX64] Looking for ./Ziggurat.x86_64
[BOX64] BOX64ENV: Variables overridden via env and/or RC file:
        BOX64_BASH=/home/sipeed/ourstorybegin/box64/box64_/tests/box64-bash
[BOX64] Rename process to "Ziggurat.x86_64"
[BOX64] Using native(wrapped) libdl.so.2
[BOX64] Using native(wrapped) libpthread.so.0
[BOX64] Using native(wrapped) librt.so.1
...
1920.715384 (23516) PVR:(Error): DoCompileShader:  Failed to compile shader [ shadercompile.c:10866 ]
...
1920.716165 (23516) PVR:(Error): DoCompileShader:  Failed to compile shader [ shadercompile.c:10866 ]
1920.716430 (23516) PVR:(Error): DoCompileShader:  Failed to compile shader [ shadercompile.c:10866 ]
1920.716684 (23516) PVR:(Error): DoCompileShader:  Failed to compile shader [ shadercompile.c:10866 ]
...
LIBGL: Current folder is:/home/sipeed/games/GOG Games/Ziggurat/game
LIBGL: Loaded a PSA with 25 Precompiled Programs
...
[BOX64] Using native(wrapped) libutil.so.1
[BOX64] Using native(wrapped) libbsd.so.0
Set current directory to /home/sipeed/games/GOG Games/Ziggurat/game
Found path: /home/sipeed/games/GOG Games/Ziggurat/game/Ziggurat.x86_64
[BOX64] Using emulated /home/sipeed/games/GOG Games/Ziggurat/game/Ziggurat_Data/Mono/x86_64/libmono.so
Mono path[0] = '/home/sipeed/games/GOG Games/Ziggurat/game/Ziggurat_Data/Managed'
Mono path[1] = '/home/sipeed/games/GOG Games/Ziggurat/game/Ziggurat_Data/Mono'
Mono config path = '/home/sipeed/games/GOG Games/Ziggurat/game/Ziggurat_Data/Mono/etc'
/dev/input/js0: driver version: 2.1.0 (20100)
/dev/input/js0: fd 6, buttons 5, axes 2, name Moyu at work Technology KVM Controlled
/dev/input/js0: axis  0: raw   -557, mapped 0.000000
/dev/input/js0: axis  1: raw  14008, mapped 0.000000
```
...
[Official Game Website](https://www.milkstonestudios.com/games/ziggurat/)

[Steam](https://store.steampowered.com/app/308420/Ziggurat/)

[PCGameWiki](https://www.pcgamingwiki.com/wiki/Ziggurat)

### Advanced Tips

You may need to lower the graphics effect settings in the `graphic settings` to avoid some rendering errors.

![screenshot](./img/Ziggurat_3.png)