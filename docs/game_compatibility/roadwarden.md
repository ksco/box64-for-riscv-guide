...
![screenshot](./img/Roadwarden_0.png)
![screenshot](./img/Roadwarden_1.png)
...
![screenshot](./img/Roadwarden_2.png)
...
[BOX64] Not an ELF file (sign=#!/b)
[BOX64] Error: Reading elf header of /home/rurumuri/GOG Games/Roadwarden/start.sh, Try to launch using bash instead
[BOX64] Box64 with Dynarec v0.3.3 2636e7e8 built on Mar  4 2025 14:58:49
[BOX64] Dynarec for rv64gv_zba_zbb_zbc_zbs_zvl256
[BOX64] Running on Spacemit(R) X60 with 8 cores, pagesize: 4096
[BOX64] Will use hardware counter measured at 24.0 MHz emulating 3.0 GHz
...
[BOX64] Library search path: 
[BOX64] Binary search path: ./:bin/:/home/rurumuri/ourstorybegin/wine/wine-10.0-amd64-wow64/bin/:/home/rurumuri/ourstorybegin/wine/wine-10.0-amd64-wow64/bin/:/usr/local/bin/:/usr/bin/:/bin/:/usr/local/sbin/:/usr/bin/site_perl/:/usr/bin/vendor_perl/:/usr/bin/core_perl/
[BOX64] Looking for /home/rurumuri/GOG Games/Roadwarden/game/lib/py2-linux-x86_64/Roadwarden
[BOX64] BOX64ENV: Variables overridden via env and/or RC file:
        BOX64_BASH=/home/rurumuri/ourstorybegin/box64/tests/box64-bash
[BOX64] Rename process to "Roadwarden"
[BOX64] Warning, cannot pre-load /usr/local/$LIB/mangohud/libMangoHud_shim.so
[BOX64] Using emulated /home/rurumuri/GOG Games/Roadwarden/game/lib/py2-linux-x86_64/librenpython.so
[BOX64] Using native(wrapped) libpthread.so.0
[BOX64] Using native(wrapped) libc.so.6
[BOX64] Using native(wrapped) ld-linux-x86-64.so.2
[BOX64] Using native(wrapped) libdl.so.2
...
[BOX64] Using native(wrapped) libXss.so.1
[BOX64] Using native(wrapped) libXxf86vm.so.1
[2025-03-02 15:14:11.982] [MANGOHUD] [error] [cpu.cpp:552] Could not find cpu temp sensor location
[BOX64] Using emulated /home/rurumuri/GOG Games/Roadwarden/game/lib/py2-linux-x86_64/libsteam_api.so
[S_API] SteamAPI_Init(): SteamAPI_IsSteamRunning() did not locate a running instance of Steam.
dlopen failed trying to load:
/home/rurumuri/.steam/sdk64/steamclient.so
with error:
Cannot dlopen("/home/rurumuri/.steam/sdk64/steamclient.so"/0x3f8dad2090, 2)

[S_API] SteamAPI_Init(): Sys_LoadModule failed to load: /home/rurumuri/.steam/sdk64/steamclient.so
[BOX64] Error loading needed lib nvdrs
[BOX64] Warning: Cannot dlopen("nvdrs"/0x60dca354, 2)
[BOX64] Using native(wrapped) libpulse-simple.so.0
[BOX64] Using native(wrapped) libpulse.so.0
[BOX64] Using native(wrapped) libasound.so.2
[BOX64] Using native(wrapped) libudev.so.1
./start.sh: line 16:  1162 Segmentation fault      (core dumped) ./"Roadwarden.sh"
```
